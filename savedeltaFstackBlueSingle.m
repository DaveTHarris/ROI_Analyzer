function  savedeltaFstackBlueSingle( handles )
...
ZZZ=fullfile(foldername,'DeltaFRGB\');
assignin('base','ZZZ',ZZZ);
if ~exist(ZZZ,'dir')
    
    mkdir(foldername,'DeltaFRGB');
    ...
    filename=fullfile(foldername,'DeltaFRGB',sprintf('%03d-%03d.tiff',minZ,maxZ));
